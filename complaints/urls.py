...
urlpatterns = [
    ...
    path('latestcomplaints/<int:pk>',views.OfficerLatestComplaints,name="officer_latest_complaints"),
    ...
    path('pending/complaints/<int:pk>/',views.OfficerPendingComplaints,name="pending_complaints"),
